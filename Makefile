...
build: node_modules $(DIST)
	@node_modules/.bin/browserify -t [ babelify --presets [ react ] ] $(MAIN_JS) -o $(BUNDLE_JS)
...
run-dev-server: node_modules
	@node_modules/.bin/budo src/scripts/main.js:src/bundle.js -- -t [ babelify --presets [ react ] ]
